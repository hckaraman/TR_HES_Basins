...
folder = '/mnt/c/Users/cagri/Desktop/Eleman/Duden/Small'
hes = '/mnt/c/Users/cagri/Desktop/Eleman/Duden/Small/lake_ED50.shp'
...
def delineation(file, folder):
    wbt.breach_depressions(os.path.join(folder, file), "DEM_breach.tif")
